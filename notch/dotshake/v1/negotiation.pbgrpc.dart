...
class NegotiationServiceClient extends $grpc.Client {
  ...
  static final _$startConnect =
      $grpc.ClientMethod<$6.NegotiationRequest, $6.NegotiationRequest>(
          '/protos.NegotiationService/StartConnect',
          ($6.NegotiationRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $6.NegotiationRequest.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.Empty> offer($6.HandshakeRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$offer, request, options: options);
  }

  $grpc.ResponseFuture<$0.Empty> answer($6.HandshakeRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$answer, request, options: options);
  }

  $grpc.ResponseFuture<$0.Empty> candidate($6.CandidateRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$candidate, request, options: options);
  }

  $grpc.ResponseStream<$6.NegotiationRequest> startConnect(
      $async.Stream<$6.NegotiationRequest> request,
      {$grpc.CallOptions? options}) {
...
abstract class NegotiationServiceBase extends $grpc.Service {
  ...
  NegotiationServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$6.CandidateRequest, $0.Empty>(
        ...
        ($0.Empty value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$6.NegotiationRequest, $6.NegotiationRequest>(
            'StartConnect',
            startConnect,
            true,
            true,
  ...
  $async.Future<$0.Empty> offer_Pre($grpc.ServiceCall call,
      $async.Future<$6.HandshakeRequest> request) async {
  ...
  $async.Future<$0.Empty> candidate_Pre($grpc.ServiceCall call,
      $async.Future<$6.CandidateRequest> request) async {
    return candidate(call, await request);
  }

  $async.Future<$0.Empty> offer(
      $grpc.ServiceCall call, $6.HandshakeRequest request);
  $async.Future<$0.Empty> answer(
      $grpc.ServiceCall call, $6.HandshakeRequest request);
  $async.Future<$0.Empty> candidate(
      $grpc.ServiceCall call, $6.CandidateRequest request);
  $async.Stream<$6.NegotiationRequest> startConnect(
      $grpc.ServiceCall call, $async.Stream<$6.NegotiationRequest> request);
}
