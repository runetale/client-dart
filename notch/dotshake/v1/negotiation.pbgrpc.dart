...
class NegotiationServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.Empty> offer($7.HandshakeRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$offer, request, options: options);
  }

  $grpc.ResponseFuture<$0.Empty> answer($7.HandshakeRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$answer, request, options: options);
  }

  $grpc.ResponseFuture<$0.Empty> candidate($7.CandidateRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$candidate, request, options: options);
  }

  $grpc.ResponseStream<$7.NegotiationRequest> startConnect(
      $async.Stream<$7.NegotiationRequest> request,
      {$grpc.CallOptions? options}) {
...
abstract class NegotiationServiceBase extends $grpc.Service {
  ...
  NegotiationServiceBase() {
    $addMethod($grpc.ServiceMethod<$7.HandshakeRequest, $0.Empty>(
        'Offer',
        offer_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$7.HandshakeRequest, $0.Empty>(
        ...
        ($core.List<$core.int> value) => $7.HandshakeRequest.fromBuffer(value),
        ($0.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$7.CandidateRequest, $0.Empty>(
        'Candidate',
        candidate_Pre,
        false,
        false,
        ...
        ($0.Empty value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$7.NegotiationRequest, $7.NegotiationRequest>(
            'StartConnect',
            startConnect,
            true,
            true,
  ...
  $async.Future<$0.Empty> offer_Pre($grpc.ServiceCall call,
      $async.Future<$7.HandshakeRequest> request) async {
  ...
  $async.Future<$0.Empty> candidate_Pre($grpc.ServiceCall call,
      $async.Future<$7.CandidateRequest> request) async {
    return candidate(call, await request);
  }

  $async.Future<$0.Empty> offer(
      $grpc.ServiceCall call, $7.HandshakeRequest request);
  $async.Future<$0.Empty> answer(
      $grpc.ServiceCall call, $7.HandshakeRequest request);
  $async.Future<$0.Empty> candidate(
      $grpc.ServiceCall call, $7.CandidateRequest request);
  $async.Stream<$7.NegotiationRequest> startConnect(
      $grpc.ServiceCall call, $async.Stream<$7.NegotiationRequest> request);
}
