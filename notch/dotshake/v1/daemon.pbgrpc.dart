...
class DaemonServiceClient extends $grpc.Client {
  static final _$connect =
      $grpc.ClientMethod<$0.Empty, $3.GetConnectionStatusResponse>(
          '/protos.DaemonService/Connect',
          ($0.Empty value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $3.GetConnectionStatusResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$3.GetConnectionStatusResponse> connect($0.Empty request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$connect, request, options: options);
  }

  $grpc.ResponseFuture<$3.GetConnectionStatusResponse> disconnect(
      $0.Empty request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$disconnect, request, options: options);
  }

  $grpc.ResponseFuture<$3.GetConnectionStatusResponse> getConnectionStatus(
      $0.Empty request,
      {$grpc.CallOptions? options}) {
...
abstract class DaemonServiceBase extends $grpc.Service {
  ...
  DaemonServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.Empty, $3.GetConnectionStatusResponse>(
        'Connect',
        connect_Pre,
        false,
        false,
  ...
  $async.Future<$3.GetConnectionStatusResponse> connect_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Empty> request) async {
    return connect(call, await request);
  }

  $async.Future<$3.GetConnectionStatusResponse> disconnect_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Empty> request) async {
    return disconnect(call, await request);
  }

  $async.Future<$3.GetConnectionStatusResponse> getConnectionStatus_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Empty> request) async {
    return getConnectionStatus(call, await request);
  }

  $async.Future<$3.GetConnectionStatusResponse> connect(
      $grpc.ServiceCall call, $0.Empty request);
  $async.Future<$3.GetConnectionStatusResponse> disconnect(
      $grpc.ServiceCall call, $0.Empty request);
  $async.Future<$3.GetConnectionStatusResponse> getConnectionStatus(
      $grpc.ServiceCall call, $0.Empty request);
}
