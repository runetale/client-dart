...
class PeerLoginSessionResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PeerLoginSessionResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protos'), createEmptyInstance: create)
    ...
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signalServerHost', protoName: 'signalServerHost')
    ..a<$fixnum.Int64>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signalServerPort', $pb.PbFieldType.OU6, protoName: 'signalServerPort', defaultOrMaker: $fixnum.Int64.ZERO)
  ...
  'Will be removed in next major version')
  PeerLoginSessionResponse copyWith(void Function(PeerLoginSessionResponse) updates) => super.copyWith((message) => updates(message as PeerLoginSessionResponse)) as PeerLoginSessionResponse; // ignore: deprecated_member_use
