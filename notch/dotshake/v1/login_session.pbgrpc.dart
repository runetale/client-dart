...
class LoginSessionServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseStream<$2.PeerLoginSessionResponse> streamPeerLoginSession(
...
abstract class LoginSessionServiceBase extends $grpc.Service {
  ...
  LoginSessionServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.Empty, $2.PeerLoginSessionResponse>(
        'StreamPeerLoginSession',
        streamPeerLoginSession,
        true,
        true,
        ($core.List<$core.int> value) => $0.Empty.fromBuffer(value),
        ($2.PeerLoginSessionResponse value) => value.writeToBuffer()));
  }

  $async.Stream<$2.PeerLoginSessionResponse> streamPeerLoginSession(
