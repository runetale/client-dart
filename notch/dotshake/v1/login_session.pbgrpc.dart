...
class LoginSessionServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseStream<$3.PeerLoginSessionResponse> streamPeerLoginSession(
...
abstract class LoginSessionServiceBase extends $grpc.Service {
  ...
  LoginSessionServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.Empty, $3.PeerLoginSessionResponse>(
        'StreamPeerLoginSession',
        streamPeerLoginSession,
        true,
        true,
        ($core.List<$core.int> value) => $0.Empty.fromBuffer(value),
        ($3.PeerLoginSessionResponse value) => value.writeToBuffer()));
  }

  $async.Stream<$3.PeerLoginSessionResponse> streamPeerLoginSession(
