...
class MachineServiceClient extends $grpc.Client {
  static final _$login = $grpc.ClientMethod<$0.Empty, $6.LoginResponse>(
  ...
  static final _$syncRemoteMachinesConfig =
      $grpc.ClientMethod<$0.Empty, $6.SyncMachinesResponse>(
          '/protos.MachineService/SyncRemoteMachinesConfig',
          ($0.Empty value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $6.SyncMachinesResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$6.LoginResponse> login($0.Empty request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$login, request, options: options);
  }

  $grpc.ResponseFuture<$6.SyncMachinesResponse> syncRemoteMachinesConfig(
      $0.Empty request,
      {$grpc.CallOptions? options}) {
...
abstract class MachineServiceBase extends $grpc.Service {
  ...
  MachineServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.Empty, $6.LoginResponse>(
        'Login',
        login_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$0.Empty, $6.SyncMachinesResponse>(
  ...
  $async.Future<$6.SyncMachinesResponse> syncRemoteMachinesConfig_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Empty> request) async {
    return syncRemoteMachinesConfig(call, await request);
  }

  $async.Future<$6.LoginResponse> login(
      $grpc.ServiceCall call, $0.Empty request);
  $async.Future<$6.SyncMachinesResponse> syncRemoteMachinesConfig(
      $grpc.ServiceCall call, $0.Empty request);
}
