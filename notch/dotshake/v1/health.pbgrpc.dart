...
class HealthServiceClient extends $grpc.Client {
  static final _$health = $grpc.ClientMethod<$0.Empty, $2.HealthResponse>(
      '/protos.HealthService/Health',
      ($0.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $2.HealthResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$2.HealthResponse> health($0.Empty request,
      {$grpc.CallOptions? options}) {
...
abstract class HealthServiceBase extends $grpc.Service {
  ...
  HealthServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.Empty, $2.HealthResponse>(
        'Health',
        health_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.Empty.fromBuffer(value),
        ($2.HealthResponse value) => value.writeToBuffer()));
  }

  $async.Future<$2.HealthResponse> health_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Empty> request) async {
    return health(call, await request);
  }

  $async.Future<$2.HealthResponse> health(
