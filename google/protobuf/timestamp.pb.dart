...
/// second table is needed for interpretation, using a technique similar to
...
/// go up to 9 digits (i.e. up to 1 nanosecond resolution), are optional.
...
/// printing the Timestamp type and a proto3 JSON parser should be able to accept
