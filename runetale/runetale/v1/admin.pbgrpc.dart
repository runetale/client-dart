...
class AdminServiceClient extends $grpc.Client {
  ...
  static final _$getComposeNodeStatus = $grpc.ClientMethod<$1.GetComposeNodeStatusRequest, $1.GetComposeNodeStatusResponse>(
      '/protos.AdminService/GetComposeNodeStatus',
      ($1.GetComposeNodeStatusRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.GetComposeNodeStatusResponse.fromBuffer(value));
  ...
  static final _$createInviteUser = $grpc.ClientMethod<$0.Empty, $1.InviteUserResponse>(
      '/protos.AdminService/CreateInviteUser',
      ($0.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.InviteUserResponse.fromBuffer(value));
  static final _$getSubnetLinkers = $grpc.ClientMethod<$0.Empty, $1.GetLinkersReponse>(
      '/protos.AdminService/GetSubnetLinkers',
      ($0.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.GetLinkersReponse.fromBuffer(value));
  static final _$createSubnetLinker = $grpc.ClientMethod<$1.CreateSubnetLinkerRequest, $1.CreateSubnetLinkerResponse>(
  ...
  $grpc.ResponseFuture<$1.GetComposeNodeStatusResponse> getComposeNodeStatus($1.GetComposeNodeStatusRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$1.GetLinkersReponse> getSubnetLinkers($0.Empty request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getSubnetLinkers, request, options: options);
  }

  $grpc.ResponseFuture<$1.CreateSubnetLinkerResponse> createSubnetLinker($1.CreateSubnetLinkerRequest request, {$grpc.CallOptions? options}) {
...
abstract class AdminServiceBase extends $grpc.Service {
  ...
  AdminServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.GetComposeNodeStatusRequest, $1.GetComposeNodeStatusResponse>(
        'GetComposeNodeStatus',
        getComposeNodeStatus_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.GetComposeNodeStatusRequest.fromBuffer(value),
        ($1.GetComposeNodeStatusResponse value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$0.Empty, $1.InviteUserResponse>(
        'CreateInviteUser',
        createInviteUser_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.Empty.fromBuffer(value),
        ($1.InviteUserResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.Empty, $1.GetLinkersReponse>(
        'GetSubnetLinkers',
        getSubnetLinkers_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.Empty.fromBuffer(value),
        ($1.GetLinkersReponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.CreateSubnetLinkerRequest, $1.CreateSubnetLinkerResponse>(
        'CreateSubnetLinker',
        createSubnetLinker_Pre,
        false,
        false,
  ...
  $async.Future<$1.GetLinkersReponse> getSubnetLinkers_Pre($grpc.ServiceCall call, $async.Future<$0.Empty> request) async {
  ...
  $async.Future<$1.GetLinkersReponse> getSubnetLinkers($grpc.ServiceCall call, $0.Empty request);
