...
class AdminServiceClient extends $grpc.Client {
  static final _$getMachines = $grpc.ClientMethod<$0.Empty, $1.GetMachinesResponse>(
      '/protos.AdminService/GetMachines',
      ($0.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.GetMachinesResponse.fromBuffer(value));
  ...
  static final _$deleteAcl = $grpc.ClientMethod<$1.DeleteAclRequest, $1.AclResponse>(
  ...
  static final _$patchAcl = $grpc.ClientMethod<$1.PatchAclRequest, $1.AclResponse>(
      ...
      ($core.List<$core.int> value) => $1.AclResponse.fromBuffer(value));
  static final _$createGroup = $grpc.ClientMethod<$1.CreateGroupRequest, $1.GroupResponse>(
  ...
  static final _$deleteGroup = $grpc.ClientMethod<$1.DeleteGroupRequest, $1.GroupResponse>(
      '/protos.AdminService/DeleteGroup',
      ($1.DeleteGroupRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.GroupResponse.fromBuffer(value));
  static final _$getGroupAndUsers = $grpc.ClientMethod<$0.Empty, $1.GroupsResponse>(
  ...
  static final _$getGroup = $grpc.ClientMethod<$0.Empty, $1.GroupsResponse>(
      ...
      ($0.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.GroupsResponse.fromBuffer(value));
  static final _$patchGroup = $grpc.ClientMethod<$1.PatchGroupRequest, $1.GroupResponse>(
  ...
  $grpc.ResponseFuture<$1.GetMachinesResponse> getMachines($0.Empty request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$1.GetUsersResponse> getUsers($0.Empty request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$1.AclResponse> deleteAcl($1.DeleteAclRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deleteAcl, request, options: options);
  }

  $grpc.ResponseFuture<$1.AclsResponse> getAcl($0.Empty request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$1.GroupResponse> createGroup($1.CreateGroupRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$createGroup, request, options: options);
  }

  $grpc.ResponseFuture<$1.GroupResponse> deleteGroup($1.DeleteGroupRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deleteGroup, request, options: options);
  }

  $grpc.ResponseFuture<$1.GroupsResponse> getGroupAndUsers($0.Empty request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getGroupAndUsers, request, options: options);
  }

  $grpc.ResponseFuture<$1.GroupsResponse> getGroup($0.Empty request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getGroup, request, options: options);
  }

  $grpc.ResponseFuture<$1.GroupResponse> patchGroup($1.PatchGroupRequest request, {$grpc.CallOptions? options}) {
...
abstract class AdminServiceBase extends $grpc.Service {
  ...
  AdminServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.DeleteGroupRequest, $1.GroupResponse>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $1.DeleteGroupRequest.fromBuffer(value),
        ($1.GroupResponse value) => value.writeToBuffer()));
  ...
  $async.Future<$1.GetMachinesResponse> getMachines_Pre($grpc.ServiceCall call, $async.Future<$0.Empty> request) async {
  ...
  $async.Future<$1.GetUsersResponse> getUsers_Pre($grpc.ServiceCall call, $async.Future<$0.Empty> request) async {
  ...
  $async.Future<$1.AclResponse> deleteAcl_Pre($grpc.ServiceCall call, $async.Future<$1.DeleteAclRequest> request) async {
    return deleteAcl(call, await request);
  }

  $async.Future<$1.AclsResponse> getAcl_Pre($grpc.ServiceCall call, $async.Future<$0.Empty> request) async {
  ...
  $async.Future<$1.GroupResponse> createGroup_Pre($grpc.ServiceCall call, $async.Future<$1.CreateGroupRequest> request) async {
    return createGroup(call, await request);
  }

  $async.Future<$1.GroupResponse> deleteGroup_Pre($grpc.ServiceCall call, $async.Future<$1.DeleteGroupRequest> request) async {
    return deleteGroup(call, await request);
  }

  $async.Future<$1.GroupsResponse> getGroupAndUsers_Pre($grpc.ServiceCall call, $async.Future<$0.Empty> request) async {
    return getGroupAndUsers(call, await request);
  }

  $async.Future<$1.GroupsResponse> getGroup_Pre($grpc.ServiceCall call, $async.Future<$0.Empty> request) async {
    return getGroup(call, await request);
  }

  $async.Future<$1.GroupResponse> patchGroup_Pre($grpc.ServiceCall call, $async.Future<$1.PatchGroupRequest> request) async {
    return patchGroup(call, await request);
  }

  $async.Future<$1.GetMachinesResponse> getMachines($grpc.ServiceCall call, $0.Empty request);
  $async.Future<$1.GetMeResponse> getMe($grpc.ServiceCall call, $0.Empty request);
  $async.Future<$1.GetUsersResponse> getUsers($grpc.ServiceCall call, $0.Empty request);
  $async.Future<$1.AclResponse> createAcl($grpc.ServiceCall call, $1.CreateAclRequest request);
  $async.Future<$1.AclResponse> deleteAcl($grpc.ServiceCall call, $1.DeleteAclRequest request);
  $async.Future<$1.AclsResponse> getAcl($grpc.ServiceCall call, $0.Empty request);
  $async.Future<$1.AclResponse> patchAcl($grpc.ServiceCall call, $1.PatchAclRequest request);
  $async.Future<$1.GroupResponse> createGroup($grpc.ServiceCall call, $1.CreateGroupRequest request);
  $async.Future<$1.GroupResponse> deleteGroup($grpc.ServiceCall call, $1.DeleteGroupRequest request);
  $async.Future<$1.GroupsResponse> getGroupAndUsers($grpc.ServiceCall call, $0.Empty request);
  $async.Future<$1.GroupsResponse> getGroup($grpc.ServiceCall call, $0.Empty request);
  $async.Future<$1.GroupResponse> patchGroup($grpc.ServiceCall call, $1.PatchGroupRequest request);
}
