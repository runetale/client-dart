...
class SessionServiceClient extends $grpc.Client {
  static final _$signIn = $grpc.ClientMethod<$8.SignInRequest, $8.SignInResponse>(
  ...
  static final _$verifyPeerLoginSession = $grpc.ClientMethod<$8.VerifyPeerLoginSessionRequest, $8.VerifyPeerLoginSessionResponse>(
      '/protos.SessionService/VerifyPeerLoginSession',
      ($8.VerifyPeerLoginSessionRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $8.VerifyPeerLoginSessionResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$8.SignInResponse> signIn($8.SignInRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$8.VerifyPeerLoginSessionResponse> verifyPeerLoginSession($8.VerifyPeerLoginSessionRequest request, {$grpc.CallOptions? options}) {
...
abstract class SessionServiceBase extends $grpc.Service {
  ...
  SessionServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$8.VerifyPeerLoginSessionRequest, $8.VerifyPeerLoginSessionResponse>(
        'VerifyPeerLoginSession',
        verifyPeerLoginSession_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $8.VerifyPeerLoginSessionRequest.fromBuffer(value),
        ($8.VerifyPeerLoginSessionResponse value) => value.writeToBuffer()));
  }

  $async.Future<$8.SignInResponse> signIn_Pre($grpc.ServiceCall call, $async.Future<$8.SignInRequest> request) async {
  ...
  $async.Future<$8.VerifyPeerLoginSessionResponse> verifyPeerLoginSession_Pre($grpc.ServiceCall call, $async.Future<$8.VerifyPeerLoginSessionRequest> request) async {
    return verifyPeerLoginSession(call, await request);
  }

  $async.Future<$8.SignInResponse> signIn($grpc.ServiceCall call, $8.SignInRequest request);
  $async.Future<$8.SignUpResponse> signUp($grpc.ServiceCall call, $8.SignUpRequest request);
  $async.Future<$8.VerifyPeerLoginSessionResponse> verifyPeerLoginSession($grpc.ServiceCall call, $8.VerifyPeerLoginSessionRequest request);
}
