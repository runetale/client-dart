...
class Acl extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Acl', package: const $pb.PackageName(_omitMessageNames ? '' : 'protos'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<Route>(2, _omitFieldNames ? '' : 'src', subBuilder: Route.create)
    ..pPS(3, _omitFieldNames ? '' : 'srcGroups')
    ..aOM<Route>(4, _omitFieldNames ? '' : 'dst', subBuilder: Route.create)
    ..pPS(5, _omitFieldNames ? '' : 'dstGroups')
    ..hasRequiredFields = false
  ;
...
class Route extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Route', package: const $pb.PackageName(_omitMessageNames ? '' : 'protos'), createEmptyInstance: create)
...
class CreateAclRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateAclRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'protos'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'aclName')
    ..aOM<Route>(2, _omitFieldNames ? '' : 'src', subBuilder: Route.create)
    ..aOM<Route>(3, _omitFieldNames ? '' : 'dst', subBuilder: Route.create)
    ..hasRequiredFields = false
  ;
...
class DeleteAclRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteAclRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'protos'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'aclId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteAclRequest copyWith(void Function(DeleteAclRequest) updates) => super.copyWith((message) => updates(message as DeleteAclRequest)) as DeleteAclRequest;
...
class AclResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AclResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'protos'), createEmptyInstance: create)
    ..aOM<Acl>(1, _omitFieldNames ? '' : 'acl', subBuilder: Acl.create)
    ..hasRequiredFields = false
  ;
...
class AclsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AclsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'protos'), createEmptyInstance: create)
    ..pc<Acl>(1, _omitFieldNames ? '' : 'acls', $pb.PbFieldType.PM, subBuilder: Acl.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AclsResponse copyWith(void Function(AclsResponse) updates) => super.copyWith((message) => updates(message as AclsResponse)) as AclsResponse;
...
class DeleteGroupRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DeleteGroupRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'protos'), createEmptyInstance: create)
...
class GroupsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GroupsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'protos'), createEmptyInstance: create)
