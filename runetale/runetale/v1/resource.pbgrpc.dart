...
class ResourceServiceClient extends $grpc.Client {
  static final _$createResource = $grpc.ClientMethod<$12.CreateResourceRequest, $12.ResourceResponse>(
  ...
  $grpc.ResponseFuture<$12.ResourceResponse> createResource($12.CreateResourceRequest request, {$grpc.CallOptions? options}) {
...
abstract class ResourceServiceBase extends $grpc.Service {
  ...
  ResourceServiceBase() {
    $addMethod($grpc.ServiceMethod<$12.CreateResourceRequest, $12.ResourceResponse>(
        'CreateResource',
        createResource_Pre,
        false,
        false,
  ...
  $async.Future<$12.ResourceResponse> createResource_Pre($grpc.ServiceCall call, $async.Future<$12.CreateResourceRequest> request) async {
  ...
  $async.Future<$12.ResourceResponse> createResource($grpc.ServiceCall call, $12.CreateResourceRequest request);
