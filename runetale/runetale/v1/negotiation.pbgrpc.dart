...
class NegotiationServiceClient extends $grpc.Client {
  ...
  static final _$candidate = $grpc.ClientMethod<$4.CandidateRequest, $0.Empty>(
      ...
      ($core.List<$core.int> value) => $0.Empty.fromBuffer(value));
  static final _$connect = $grpc.ClientMethod<$4.NegotiationRequest, $4.NegotiationRequest>(
      '/protos.NegotiationService/Connect',
      ($4.NegotiationRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $4.NegotiationRequest.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.Empty> offer($4.HandshakeRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$offer, request, options: options);
  }

  $grpc.ResponseFuture<$0.Empty> answer($4.HandshakeRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$answer, request, options: options);
  }

  $grpc.ResponseFuture<$0.Empty> candidate($4.CandidateRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$candidate, request, options: options);
  }

  $grpc.ResponseStream<$4.NegotiationRequest> connect($async.Stream<$4.NegotiationRequest> request, {$grpc.CallOptions? options}) {
...
abstract class NegotiationServiceBase extends $grpc.Service {
  ...
  NegotiationServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$4.CandidateRequest, $0.Empty>(
        ...
        ($0.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$4.NegotiationRequest, $4.NegotiationRequest>(
        'Connect',
        connect,
        true,
        true,
  ...
  $async.Future<$0.Empty> answer($grpc.ServiceCall call, $4.HandshakeRequest request);
  $async.Future<$0.Empty> candidate($grpc.ServiceCall call, $4.CandidateRequest request);
  $async.Stream<$4.NegotiationRequest> connect($grpc.ServiceCall call, $async.Stream<$4.NegotiationRequest> request);
}
