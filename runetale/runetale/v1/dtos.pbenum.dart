...
class OS extends $pb.ProtobufEnum {
  static const OS OS_UNSPECIFIED =
      OS._(0, _omitEnumNames ? '' : 'OS_UNSPECIFIED');
  ...
  static final $core.List<OS?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 6);
  static OS? valueOf($core.int value) =>
...
class Platform extends $pb.ProtobufEnum {
  ...
  static const Platform PLATFORM_DOCKER =
      Platform._(1, _omitEnumNames ? '' : 'PLATFORM_DOCKER');
  static const Platform PLATFORM_CLI =
      Platform._(2, _omitEnumNames ? '' : 'PLATFORM_CLI');
  static const Platform PLATFORM_LINUX =
      Platform._(3, _omitEnumNames ? '' : 'PLATFORM_LINUX');
  static const Platform PLATFORM_GCP =
      Platform._(4, _omitEnumNames ? '' : 'PLATFORM_GCP');
  static const Platform PLATFORM_MANUAL =
      Platform._(5, _omitEnumNames ? '' : 'PLATFORM_MANUAL');
  static const Platform PLATFORM_AWS =
      Platform._(6, _omitEnumNames ? '' : 'PLATFORM_AWS');
  static const Platform PLATFORM_AZURE =
      Platform._(7, _omitEnumNames ? '' : 'PLATFORM_AZURE');
  static const Platform PLATFORM_ONPREM =
      Platform._(8, _omitEnumNames ? '' : 'PLATFORM_ONPREM');
  static const Platform PLATFORM_MACOS =
      Platform._(9, _omitEnumNames ? '' : 'PLATFORM_MACOS');
  static const Platform PLATFORM_WINDOWS =
      Platform._(10, _omitEnumNames ? '' : 'PLATFORM_WINDOWS');
  static const Platform PLATFORM_OTHER =
      Platform._(11, _omitEnumNames ? '' : 'PLATFORM_OTHER');
...
class IPProto extends $pb.ProtobufEnum {
  static const IPProto IP_PROTO_UNSPECIFIED =
      IPProto._(0, _omitEnumNames ? '' : 'IP_PROTO_UNSPECIFIED');
  static const IPProto IP_PROTO_ALL =
      IPProto._(1, _omitEnumNames ? '' : 'IP_PROTO_ALL');
  static const IPProto IP_PROTO_TCP =
      IPProto._(2, _omitEnumNames ? '' : 'IP_PROTO_TCP');
  static const IPProto IP_PROTO_UDP =
      IPProto._(3, _omitEnumNames ? '' : 'IP_PROTO_UDP');
  static const IPProto IP_PROTO_ICMPV4 =
      IPProto._(4, _omitEnumNames ? '' : 'IP_PROTO_ICMPV4');
  static const IPProto IP_PROTO_ICMPV6 =
      IPProto._(5, _omitEnumNames ? '' : 'IP_PROTO_ICMPV6');
  ...
  static final $core.List<IPProto?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 5);
  static IPProto? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class UserRoles extends $pb.ProtobufEnum {
  static const UserRoles USER_ROLE_UNSPECIFIED =
      UserRoles._(0, _omitEnumNames ? '' : 'USER_ROLE_UNSPECIFIED');
  static const UserRoles USER_ROLE_ADMIN =
      UserRoles._(1, _omitEnumNames ? '' : 'USER_ROLE_ADMIN');
  static const UserRoles USER_ROLE_USER =
      UserRoles._(2, _omitEnumNames ? '' : 'USER_ROLE_USER');
  ...
  static final $core.List<UserRoles?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static UserRoles? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];
