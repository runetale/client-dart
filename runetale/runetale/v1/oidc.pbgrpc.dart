...
class OIDCServiceClient extends $grpc.Client {
  ...
  static final _$authenticate = $grpc.ClientMethod<$1.Empty, $8.AuthenticateResponse>(
      '/protos.OIDCService/Authenticate',
      ($1.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $8.AuthenticateResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$8.LoginResponse> login($8.LoginRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$login, request, options: options);
  }

  $grpc.ResponseFuture<$8.AuthenticateResponse> authenticate($1.Empty request, {$grpc.CallOptions? options}) {
...
abstract class OIDCServiceBase extends $grpc.Service {
  ...
  OIDCServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.Empty, $8.AuthenticateResponse>(
        'Authenticate',
        authenticate_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.Empty.fromBuffer(value),
        ($8.AuthenticateResponse value) => value.writeToBuffer()));
  }

  $async.Future<$8.LoginResponse> login_Pre($grpc.ServiceCall call, $async.Future<$8.LoginRequest> request) async {
    return login(call, await request);
  }

  $async.Future<$8.AuthenticateResponse> authenticate_Pre($grpc.ServiceCall call, $async.Future<$1.Empty> request) async {
    return authenticate(call, await request);
  }

  $async.Future<$8.LoginResponse> login($grpc.ServiceCall call, $8.LoginRequest request);
  $async.Future<$8.AuthenticateResponse> authenticate($grpc.ServiceCall call, $1.Empty request);
}
