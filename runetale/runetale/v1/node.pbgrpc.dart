...
class NodeServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseStream<$6.NetworkMapResponse> getNetworkMap($async.Stream<$0.Empty> request, {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$getNetworkMap, request, options: options);
  }
}
...
abstract class NodeServiceBase extends $grpc.Service {
  ...
  $async.Stream<$6.NetworkMapResponse> getNetworkMap($grpc.ServiceCall call, $async.Stream<$0.Empty> request);
}
